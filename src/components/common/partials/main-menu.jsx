    ...
    return (
        <nav className="main-nav w-100">
            <ul className="menu sf-arrows">
                <li><Link to={ `${ process.env.PUBLIC_URL }/` }>AUCTION</Link></li>
                <li className={ path.indexOf( "categories/" ) > -1 ? 'active' : '' }>
                    <Link to={ `${ process.env.PUBLIC_URL }/categories/full-width` } className="sf-with-ul">BABY & KIDS{ badgePos === 1 ? <span className="tip tip-new tip-top">New</span> : '' }</Link>
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                ...
                                <ul className="submenu">
                                    ...
                                    <li><Link to={ `${ process.env.PUBLIC_URL }/categories/flex-grid` }>Auction</Link></li>
                ...
                <li className={ path.indexOf( "products/" ) > -1 ? 'active' : '' }>
                    <Link to={ `${ process.env.PUBLIC_URL }/products/default/15` } className="sf-with-ul">GADGETS</Link>
                    <div className="megamenu megamenu-fixed-width">
                        <div className="row">
                            <div className="col-lg-3">
                                <Link to={ `${ process.env.PUBLIC_URL }/products/horizontal/15` } className="nolink">Variations 1</Link>
                            ...
                            <div className="col-lg-3">
                                <Link to={ `${ process.env.PUBLIC_URL }/products/sticky-tab/15` } className="nolink">Variations 2</Link>
                ...
                <li className={ path.indexOf( "pages/" ) > -1 ? 'active' : '' }>
                    <Link to={ `${ process.env.PUBLIC_URL }/pages/cart` } className="sf-with-ul">BEAUTY</Link>
                ...
                <li>
                    <Link to={ `${ process.env.PUBLIC_URL }/pages/about` }>APPLIANCES</Link>
                </li>
